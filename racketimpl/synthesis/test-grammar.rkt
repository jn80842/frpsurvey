...
(define s-integer-evts (new-event-stream sym-integer 1 2))
;(define s-integer-evts2 (new-event-stream sym-integer 1 2))
;(define s-integer-behavior (new-behavior sym-integer 1 2))
;(define s-integer-behavior2 (new-behavior sym-integer 1 2))
;(define s-boolean-evts (new-event-stream sym-boolean 1 2))
;(define s-boolean-behavior (new-behavior sym-boolean 1 2))
;(define s-boolean-behavior2 (new-behavior sym-boolean 1 2))
;(define s-stream-of-streams (new-event-stream (λ () (new-event-stream sym-integer 2)) 1 2))
;(define s-light-behavior (new-behavior (sym-union-constructor 'on 'off) 1 2))
;(define s-mode-behavior (new-behavior (sym-union-constructor 'night 'home) 1 2))
