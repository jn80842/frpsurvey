...
(define s-motion-sensorB (new-behavior sym-boolean stream-length (* 2 stream-length)))
(define s-locationB (new-behavior sym-location stream-length (* 2 stream-length)))
