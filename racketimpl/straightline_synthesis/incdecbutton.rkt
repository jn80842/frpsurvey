...
(define holes-structure (for/list ([i (range 5)])
                          (get-insn-holes)))
...
(define (sketch-graph input1 input2)
  (define r1 input1)
  (define r2 input2)
  (define r3 (call-stream-insn (list-ref holes-structure 0) (list r1 r2)))
  (define r4 (call-stream-insn (list-ref holes-structure 1) (list r1 r2 r3)))
  (define r5 (call-stream-insn (list-ref holes-structure 2) (list r1 r2 r3 r4)))
  (define r6 (call-stream-insn (list-ref holes-structure 3) (list r1 r2 r3 r4 r5)))
  (define r7 (call-stream-insn (list-ref holes-structure 4) (list r1 r2 r3 r4 r5 r6)))
...
(if (unsat? binding)
    ...
    (print-from-holes holes-structure retval-idx binding 5 2))
