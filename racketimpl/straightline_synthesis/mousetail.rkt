...
(if (unsat? spec-binding)
    ...
    (begin (print-from-holes x-holes x-retval-idx spec-binding 2 1)
           (print-from-holes y-holes y-retval-idx spec-binding 1 1)))
...
(if (unsat? distinguishing-binding)
    ...
    (begin (displayln "first mouse-x solution")
           (print-from-holes x-holes x-retval-idx distinguishing-binding 2 1)
           (displayln "second mouse-x solution")
           (print-from-holes x-holes-prime x-retval-idx-prime distinguishing-binding 2 1)
           ...
           (print-from-holes y-holes y-retval-idx distinguishing-binding 1 1)
           (displayln "second mouse-y solution")
           (print-from-holes y-holes-prime y-retval-idx-prime distinguishing-binding 2 1)
